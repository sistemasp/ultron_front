...
const ReportesBiopsias = (props) => {
	...
	const columns = [
		...
		{ title: 'QUIÉN ENTRAGA', field: 'quien_entrega' },
		{ title: 'FECHA ENTREGA RESULTADO', field: 'fecha_entrega_resultado' },
		{ title: 'QUIÉN RECIBE', field: 'quien_recibe' },
		{ title: 'DIAGNÓSTICO', field: 'diagnostico' },
		{ title: 'A QUIÉN SE ENTREGA', field: 'a_quien_se_entrega' },
		{ title: 'FECHA ENTREGA', field: 'fecha_entrega' },
		{ title: 'QUIÉN LO ENTREGA', field: 'quien_lo_entrega' },
